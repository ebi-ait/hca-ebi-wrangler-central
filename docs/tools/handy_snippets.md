...
IMPORTANT
{: .label .label-red } For optimal visual experience in the Neo4j Browser, turn autocomplete off by going to the bottom of the settings menu and unticking `Connect result nodes`.
