...
| Column name                          | description                                                                         | how to make                                                             |
|--------------------------------------|-------------------------------------------------------------------------------------|-------------------------------------------------------------------------|
| cell ID                              | A unique identifier for each cell in the experiment                                 | `Comment[RUN]-barcode` e.g.`4834STDY7002875_S1_L001-AAAGCAATCCATGAGT`   |
| Comment[RUN]                         | The run identifier from the sdrf file                                               | `Comment[RUN]`                                                          |
...
Information about the cell type annotations can usually be found in the paper's supplementary materials or by contacting the author directly.
