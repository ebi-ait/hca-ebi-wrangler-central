...
- [Metadata Schema repository - schema versioning](https://github.com/HumanCellAtlas/metadata-schema/blob/master/docs/evolution.md#schema-versioning): This document explains what defines major, minor, and patch changes to the metadata schema.
- [Metadata Schema repository - making a schema change](https://github.com/HumanCellAtlas/metadata-schema/blob/master/docs/committers.md#before-making-changes): This document describes how to create a schema update PR. The information on PR reviews is out of date!
- [DCP2 specs - review process](https://github.com/HumanCellAtlas/dcp2/blob/main/docs/dcp2_operating_procedures.rst#dcp2-operating-procedures): This document explains the impact of schema changes and the review process for the PR.
- [DCP2 specs - reviewers](https://github.com/HumanCellAtlas/dcp2/blob/main/docs/dcp2_operating_procedures.rst#designated-reviewers) : designated schema PR reviewers
- [Metadata Schema repository - release process](https://github.com/HumanCellAtlas/metadata-schema/blob/master/docs/release_process.md): pre-release and release process for schema updates. Wranglers are responsible for releasing the schema changes
...
> @Enrique Sapena Ventura @Amnon @rmunshi @kdegs @aherbst @Hannes @Dave Rogers Could you please review it?
> 
